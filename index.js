...
// For Heroku apps we use process.env.PORT or we can force 8080 for devs
...
// saveUninitialized - Forces a session that is "uninitialized" to be saved to
//                     the store.
// https:// www.npmjs.com/package/express-session
app.use(session({
  secret: 'avenuecode-passport-training',
  resave: true,
